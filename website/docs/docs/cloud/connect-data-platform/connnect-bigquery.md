...
<DetailsToggle alt_header="Location">
...
<DetailsToggle alt_header="Maximum bytes build">
...
<DetailsToggle alt_header="Job creation timeout seconds">
...
<DetailsToggle alt_header="Dataproc cluster name">
